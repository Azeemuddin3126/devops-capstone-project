...
def create_account():
    ...
    location_url = f"/accounts/{account.id}"  # Fixed the location URL
...
def get_account(account_id):
    ...
    This endpoint will return an Account based on the given account_id.
    """
...
def update_account(account_id):
    ...
    This endpoint will update an Account based on the given account_id.
    """
